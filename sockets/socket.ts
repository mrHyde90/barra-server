...
export const apartarMesa = (cliente: Socket, io: socketIO.Server) =>{
    cliente.on("apartar-mesa", (payload: {nombre: string, mesa: string}) => {
        console.log("Apartando mesa");
        const qrGen = payload.nombre + " Pasar a pagar al siguiente enlace: " + "https://www.paypal.com/us/home";
        const consumidor:any = {nombre: payload.nombre, mesa: payload.mesa, qrcode: qrGen};
